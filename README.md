...
&#8680;&#8680; Check out my [LIVE DEMO](https://serene-roentgen-11aee5.netlify.app) 
...
3. Add `isSwitching` state as Boolean to add and remove class animated UI display.
4. Work on responsive to provide optimal user interface for different screen size.
<br><br>
